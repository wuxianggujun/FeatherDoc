...
foreach ($marker in @(
    ...
    Assert-ContainsText -Text $indexDoc -ExpectedText $marker `
        -Message "Sphinx index should preserve document skeleton governance route marker '$marker'."
}
...
foreach ($marker in @(
    ...
    Assert-ContainsText -Text $readme -ExpectedText $marker `
        -Message "README should preserve document skeleton governance route marker '$marker'."
}
