...
Assert-LineContainsAll -Path $bodyPath -ExpectedFragments @(
    ...
    'business_document_type_summary=invoice=2, policy=1',
    'corpus_role_summary=planned-business-template=1, registered-business-template=2',
    'requires_reviewer_action=True',
    'reviewer_action_summary=review_schema_update_candidate',
    'reviewer_action_reason=latest_review_state=pending; issue_keys=(none)',
    'reviewer_actions=review_schema_update_candidate',
...
Assert-Contains -Path $guidePath -ExpectedText 'fixed_layout_table_count=1' -Label 'ARTIFACT_GUIDE.md'
Assert-Contains -Path $guidePath -ExpectedText 'autofit_layout_table_count=1' -Label 'ARTIFACT_GUIDE.md'
Assert-Contains -Path $guidePath -ExpectedText 'unspecified_layout_table_count=1' -Label 'ARTIFACT_GUIDE.md'
...
Assert-Contains -Path $checklistPath -ExpectedText 'fixed_layout_table_count=1' -Label 'REVIEWER_CHECKLIST.md'
Assert-Contains -Path $checklistPath -ExpectedText 'autofit_layout_table_count=1' -Label 'REVIEWER_CHECKLIST.md'
Assert-Contains -Path $checklistPath -ExpectedText 'unspecified_layout_table_count=1' -Label 'REVIEWER_CHECKLIST.md'
...
Assert-Contains -Path $startHerePath -ExpectedText 'fixed_layout_table_count=1' -Label 'START_HERE.md'
Assert-Contains -Path $startHerePath -ExpectedText 'autofit_layout_table_count=1' -Label 'START_HERE.md'
Assert-Contains -Path $startHerePath -ExpectedText 'unspecified_layout_table_count=1' -Label 'START_HERE.md'
