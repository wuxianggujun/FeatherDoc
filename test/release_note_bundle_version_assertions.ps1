...
Assert-Contains -Path $guidePath -ExpectedText 'Project template workflow dashboard next action groups: 1' -Label 'ARTIFACT_GUIDE.md'
...
Assert-Contains -Path $checklistPath -ExpectedText 'Project template workflow dashboard next action groups: 1' -Label 'REVIEWER_CHECKLIST.md'
...
Assert-Contains -Path $startHerePath -ExpectedText 'Project template workflow dashboard next action groups: 1' -Label 'START_HERE.md'
