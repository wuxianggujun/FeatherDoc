...
$releaseGovernanceFiles = @(
    ...
    "test\build_release_blocker_rollup_report_edge_scenarios.ps1",
    "test\build_release_blocker_rollup_report_fixtures.ps1",
    "test\build_release_blocker_rollup_report_helpers.ps1",
    "test\build_release_blocker_rollup_report_passing_scenario.ps1",
    ...
    "test\build_release_governance_pipeline_report_test_helpers.ps1",
