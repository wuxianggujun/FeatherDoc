...
. (Join-Path $PSScriptRoot "project_template_release_readiness_checklist_docs_contract_helpers.ps1")
...
. (Join-Path $PSScriptRoot "project_template_release_readiness_checklist_docs_contract_inputs.ps1")
...
foreach ($marker in @(
    ...
    '"release_blockers", "action_items", "warnings"',
    "ReportId",
    "SourceSchema",
    "itemReportId",
    "itemSourceSchema",
