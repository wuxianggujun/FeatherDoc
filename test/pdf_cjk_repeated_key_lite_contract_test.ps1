...
$sampleId = "document-cjk-repeated-key-lite-text"
$sampleKind = "document_cjk_repeated_key_lite_text"
$builderName = "build_document_cjk_repeated_key_lite_text_sample"
$outputFile = "featherdoc-pdf-regression-document-cjk-repeated-key-lite-text.pdf"
...
Assert-ContainsText -Text $sampleText -ExpectedText "Document CJK Font Embed Lite" `
    -Message "PDF CJK repeated key lite should reuse the CJK font embed family."
Assert-ContainsText -Text $sampleText -ExpectedText "DocumentPdfCjkFontEmbedLiteAccent" `
    -Message "PDF CJK repeated key lite should exercise styled accent text."
Assert-ContainsText -Text $sampleText -ExpectedText "DocumentPdfCjkFontEmbedLiteNote" `
    -Message "PDF CJK repeated key lite should exercise styled note text."
Assert-ContainsText -Text $sampleText -ExpectedText "RK-101" `
    -Message "PDF CJK repeated key lite should keep stable key RK-101."
Assert-ContainsText -Text $sampleText -ExpectedText "RK-777" `
    -Message "PDF CJK repeated key lite should keep stable shared key RK-777."
Assert-ContainsText -Text $sampleText -ExpectedText "RK-999" `
    -Message "PDF CJK repeated key lite should keep stable key RK-999."
...
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expected_pages": 1' `
    -Message "PDF CJK repeated key lite should stay a one-page lightweight sample."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "RK-101" `
    -Message "PDF CJK repeated key lite manifest should include RK-101."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "RK-777" `
    -Message "PDF CJK repeated key lite manifest should include RK-777."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "RK-999" `
    -Message "PDF CJK repeated key lite manifest should include RK-999."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_cjk": true' `
    -Message "PDF CJK repeated key lite manifest should require CJK handling."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_unicode": true' `
    -Message "PDF CJK repeated key lite manifest should require Unicode handling."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_styled_text": true' `
    -Message "PDF CJK repeated key lite manifest should mark styled text."
...
Write-Host "PDF CJK repeated key lite contract passed."
