...
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"text_layer_expected_text": [' `
    -Message "PDF table CJK wrap flow manifest should carry PyMuPDF text-layer expectations."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "CJK wrap first footer 1 / 1" `
    -Message "PDF table CJK wrap flow text-layer gate should match first-page footer extraction."
