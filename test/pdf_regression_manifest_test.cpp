...
TEST_CASE("PDF regression manifest exists and declares the initial samples") {
    ...
    expect_sample("document-cjk-multi-anchor-table-flow-text",
                  "document_cjk_multi_anchor_table_flow_text", 5U, 35U, 4U);
    expect_sample("document-cjk-anchor-font-matrix-boundary-text",
                  "document_cjk_anchor_font_matrix_boundary_text", 4U, 36U,
                  4U);
    ...
    expect_sample("document-cjk-style-overlay-page-flow-text",
                  "document_cjk_style_overlay_page_flow_text", 6U, 35U, 4U);
    expect_sample("document-cjk-numbered-list-page-flow-text",
                  "document_cjk_numbered_list_page_flow_text", 5U, 28U, 4U);
    expect_sample("document-cjk-bullet-page-flow-text",
                  "document_cjk_bullet_page_flow_text", 5U, 28U, 4U);
    expect_sample("document-cjk-bullet-overlay-page-flow-text",
                  "document_cjk_bullet_overlay_page_flow_text", 5U, 28U, 4U);
