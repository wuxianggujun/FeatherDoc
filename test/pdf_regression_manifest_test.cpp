...
TEST_CASE("PDF regression manifest exists and declares the initial samples") {
    ...
    CHECK_EQ(samples[35].id, "document-table-semantics-text");
    CHECK_EQ(samples[35].kind, "document_table_semantics_text");
    CHECK_EQ(samples[35].expected_pages, 2U);
    CHECK_GE(samples[35].expected_text.size(), 4U);
    CHECK_EQ(samples[36].id, "document-long-flow-text");
    CHECK_EQ(samples[36].kind, "document_long_flow_text");
    CHECK_EQ(samples[36].expected_pages, 5U);
    CHECK_GE(samples[36].expected_text.size(), 7U);
    CHECK_EQ(samples[37].id, "document-invoice-table-text");
    CHECK_EQ(samples[37].kind, "document_invoice_table_text");
    CHECK_EQ(samples[37].expected_pages, 1U);
    CHECK_GE(samples[37].expected_text.size(), 8U);
    CHECK_EQ(samples[38].id, "document-style-gallery-text");
    CHECK_EQ(samples[38].kind, "document_style_gallery_text");
    CHECK_EQ(samples[38].expected_pages, 1U);
    CHECK_GE(samples[38].expected_text.size(), 7U);
    CHECK_EQ(samples[39].id, "strikethrough-text");
    CHECK_EQ(samples[39].kind, "strikethrough_text");
    CHECK_EQ(samples[39].expected_pages, 1U);
    CHECK_GE(samples[39].expected_text.size(), 3U);
    CHECK_EQ(samples[40].id, "style-superscript-subscript-text");
    CHECK_EQ(samples[40].kind, "style_superscript_subscript_text");
    CHECK_EQ(samples[40].expected_pages, 1U);
    CHECK_GE(samples[40].expected_text.size(), 3U);
    CHECK_EQ(samples[41].id, "document-rtl-bidi-text");
    CHECK_EQ(samples[41].kind, "document_rtl_bidi_text");
    CHECK_EQ(samples[41].expected_pages, 1U);
    CHECK_GE(samples[41].expected_text.size(), 7U);
    CHECK_EQ(samples[42].id, "document-font-matrix-text");
    CHECK_EQ(samples[42].kind, "document_font_matrix_text");
    CHECK_EQ(samples[42].expected_pages, 1U);
    CHECK_GE(samples[42].expected_text.size(), 12U);
    CHECK_EQ(samples[43].id, "header-footer-rtl-text");
    CHECK_EQ(samples[43].kind, "header_footer_rtl_text");
    CHECK_EQ(samples[43].expected_pages, 1U);
    CHECK_GE(samples[43].expected_text.size(), 8U);
    CHECK_EQ(samples[44].id, "header-footer-rtl-variants-text");
    ...
    CHECK_EQ(samples[46].id, "document-table-header-footer-variants-text");
    CHECK_EQ(samples[46].kind, "document_table_header_footer_variants_text");
    CHECK_EQ(samples[46].expected_pages, 3U);
    CHECK_GE(samples[46].expected_text.size(), 14U);
    CHECK_EQ(samples[47].id, "document-table-wrap-flow-text");
    CHECK_EQ(samples[47].kind, "document_table_wrap_flow_text");
    CHECK_EQ(samples[47].expected_pages, 3U);
    CHECK_GE(samples[47].expected_text.size(), 12U);
    CHECK_EQ(samples[48].id, "document-table-cjk-wrap-flow-text");
    ...
    CHECK_EQ(samples[54].id, "document-table-merged-cant-split-text");
    CHECK_EQ(samples[54].kind, "document_table_merged_cant_split_text");
    CHECK_EQ(samples[54].expected_pages, 3U);
    CHECK_GE(samples[54].expected_text.size(), 10U);
    CHECK_EQ(samples[55].id, "document-table-vertical-merged-cant-split-text");
    CHECK_EQ(samples[55].kind, "document_table_vertical_merged_cant_split_text");
    CHECK_EQ(samples[55].expected_pages, 4U);
    CHECK_GE(samples[55].expected_text.size(), 10U);
    CHECK_EQ(samples[56].id,
             "document-table-cjk-vertical-merged-cant-split-text");
    CHECK_EQ(samples[56].kind,
             "document_table_cjk_vertical_merged_cant_split_text");
    CHECK_EQ(samples[56].expected_pages, 3U);
