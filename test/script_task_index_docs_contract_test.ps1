...
foreach ($marker in @(
        ...
        "staged release materials",
        "release_assets_manifest.json",
        "table-layout release review aliases",
        "staged release material safety audit",
