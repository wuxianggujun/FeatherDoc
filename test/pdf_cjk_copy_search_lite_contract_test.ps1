...
$sampleId = "document-cjk-copy-search-lite-text"
$sampleKind = "document_cjk_copy_search_lite_text"
$builderName = "build_document_cjk_copy_search_lite_text_sample"
$styleBuilderName = "define_document_cjk_copy_search_lite_styles"
$outputFile = "featherdoc-pdf-regression-document-cjk-copy-search-lite-text.pdf"
...
Assert-ContainsText -Text $sampleText -ExpectedText "Document CJK Copy Search Lite" `
    -Message "PDF CJK copy/search lite should map an East Asia font family."
Assert-ContainsText -Text $sampleText -ExpectedText "DocumentPdfCjkCopySearchLiteAccent" `
    -Message "PDF CJK copy/search lite should exercise styled CJK text runs."
Assert-ContainsText -Text $sampleText -ExpectedText "CS-101" `
    -Message "PDF CJK copy/search lite should keep stable key CS-101."
Assert-ContainsText -Text $sampleText -ExpectedText "CS-202" `
    -Message "PDF CJK copy/search lite should keep stable key CS-202."
Assert-ContainsText -Text $sampleText -ExpectedText "CS-999" `
    -Message "PDF CJK copy/search lite should keep stable key CS-999."
...
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expected_pages": 1' `
    -Message "PDF CJK copy/search lite should stay a one-page lightweight sample."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "CS-101" `
    -Message "PDF CJK copy/search lite manifest should include CS-101."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "CS-202" `
    -Message "PDF CJK copy/search lite manifest should include CS-202."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "CS-999" `
    -Message "PDF CJK copy/search lite manifest should include CS-999."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_cjk": true' `
    -Message "PDF CJK copy/search lite manifest should require CJK handling."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_unicode": true' `
    -Message "PDF CJK copy/search lite manifest should require Unicode handling."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_styled_text": true' `
    -Message "PDF CJK copy/search lite manifest should mark styled text."
...
Write-Host "PDF CJK copy/search lite contract passed."
