...
$sampleId = "document-cjk-anchor-matrix-lite-text"
$sampleKind = "document_cjk_anchor_matrix_lite_text"
$builderName = "build_document_cjk_anchor_matrix_lite_text_sample"
$outputFile = "featherdoc-pdf-regression-document-cjk-anchor-matrix-lite-text.pdf"
...
Assert-ContainsText -Text $sampleText -ExpectedText "Document CJK Font Embed Lite" `
    -Message "PDF CJK anchor matrix lite should reuse the CJK font embed family."
Assert-ContainsText -Text $sampleText -ExpectedText "DocumentPdfCjkFontEmbedLiteAccent" `
    -Message "PDF CJK anchor matrix lite should exercise styled accent text."
Assert-ContainsText -Text $sampleText -ExpectedText "DocumentPdfCjkFontEmbedLiteLarge" `
    -Message "PDF CJK anchor matrix lite should exercise large styled text."
Assert-ContainsText -Text $sampleText -ExpectedText "AM-101" `
    -Message "PDF CJK anchor matrix lite should keep stable key AM-101."
Assert-ContainsText -Text $sampleText -ExpectedText "AM-202" `
    -Message "PDF CJK anchor matrix lite should keep stable key AM-202."
Assert-ContainsText -Text $sampleText -ExpectedText "AM-303" `
    -Message "PDF CJK anchor matrix lite should keep stable key AM-303."
Assert-ContainsText -Text $sampleText -ExpectedText "AM-999" `
    -Message "PDF CJK anchor matrix lite should keep stable key AM-999."
...
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expected_pages": 1' `
    -Message "PDF CJK anchor matrix lite should stay a one-page lightweight sample."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "AM-101" `
    -Message "PDF CJK anchor matrix lite manifest should include AM-101."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "AM-202" `
    -Message "PDF CJK anchor matrix lite manifest should include AM-202."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "AM-303" `
    -Message "PDF CJK anchor matrix lite manifest should include AM-303."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText "AM-999" `
    -Message "PDF CJK anchor matrix lite manifest should include AM-999."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_cjk": true' `
    -Message "PDF CJK anchor matrix lite manifest should require CJK handling."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_unicode": true' `
    -Message "PDF CJK anchor matrix lite manifest should require Unicode handling."
Assert-ContainsText -Text $manifestSampleBlock -ExpectedText '"expect_styled_text": true' `
    -Message "PDF CJK anchor matrix lite manifest should mark styled text."
...
Write-Host "PDF CJK anchor matrix lite contract passed."
