...
> 本文档定义 FeatherDoc Core 当前的 Word ⇄ PDF 双向转换整体架构方案。
>
> 阅读前置：[02-current-roadmap.md](02-current-roadmap.md)、
> [03-long-term-roadmap.md](03-long-term-roadmap.md)、[dependencies/pdfio.md](dependencies/pdfio.md)。
...
[02-current-roadmap.md](02-current-roadmap.md)。本架构文档只记录工程边界。
...
现有 [03-long-term-roadmap.md](03-long-term-roadmap.md) 中的 `LayoutResult` 可作为这一层的
中间结果。
...
- 本文是 Word ⇄ PDF 转换器的总览。
- [02-current-roadmap.md](02-current-roadmap.md) 是当前优先执行的阶段计划。
- [dependencies/pdfium.md](dependencies/pdfium.md) 记录 PDFium 源码 provider 的构建流程。
- [03-long-term-roadmap.md](03-long-term-roadmap.md) 覆盖长期自研排版的渲染愿景。
- [dependencies/pdfio.md](dependencies/pdfio.md) 只覆盖 PDFio 写出层。
- [00-vision.md](00-vision.md) 解释为什么转换不是一个单一黑盒库。
