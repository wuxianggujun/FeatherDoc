...
function Assert-GeneratedDocxEvidence { param([string]$DocxPath)
    ...
    foreach ($text in @('w:date="2026-05-02T12:00:00Z"','w:date="2026-05-02T12:10:00Z"','w:date="2026-05-02T12:25:00Z"','w:author="Updated Responder"')) { if (-not $commentsXml.Contains($text)) { throw "Missing dated comment metadata evidence: $text" } }
    if ($commentsXml.Contains('w:date="2026-05-02T12:20:00Z"')) { throw "Original threaded reply date should have been updated" }
