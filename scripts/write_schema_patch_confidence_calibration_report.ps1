...
$businessTemplateCorpusSummary = New-BusinessTemplateCorpusSummary -Entries $entryArray -RepoRoot $repoRoot
...
$summaryObject = [ordered]@{
    ...
    business_template_corpus_summary = $businessTemplateCorpusSummary
