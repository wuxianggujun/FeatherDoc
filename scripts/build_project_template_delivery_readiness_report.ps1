...
$summary = [ordered]@{
    ...
    business_document_type_summary = @(Add-SummaryGroup -Items $templates.ToArray() -PropertyName "business_document_type" -OutputName "document_type")
    corpus_role_summary = @(Add-SummaryGroup -Items $templates.ToArray() -PropertyName "corpus_role" -OutputName "corpus_role")
