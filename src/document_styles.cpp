...
auto to_table_style_border_style(featherdoc::border_style style) -> const char * {
    switch (style) {
...
auto to_table_style_border_name(featherdoc::table_border_edge edge) -> const char * {
    switch (edge) {
...
auto to_table_style_margin_name(featherdoc::cell_margin_edge edge) -> const char * {
    switch (edge) {
...
void apply_table_style_border_definition(pugi::xml_node border_node,
    ...
    ensure_attribute_value(border_node, "w:val", to_table_style_border_style(border.style));
...
auto ensure_table_style_table_properties_node(pugi::xml_node parent) -> pugi::xml_node {
    if (parent == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_cell_properties_node(pugi::xml_node parent) -> pugi::xml_node {
    if (parent == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_run_properties_node(pugi::xml_node parent) -> pugi::xml_node {
    if (parent == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_conditional_node(pugi::xml_node style, std::string_view type_name)
    -> pugi::xml_node {
    if (style == pugi::xml_node{}) {
        return {};
    }
    ...
    for (auto conditional = style.child("w:tblStylePr");
        ...
        if (std::string_view{conditional.attribute("w:type").value()} == type_name) {
            return conditional;
        }
        last_conditional = conditional;
    }

    auto conditional = last_conditional != pugi::xml_node{}
...
auto ensure_table_style_shading_node(pugi::xml_node cell_properties) -> pugi::xml_node {
    if (cell_properties == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_paragraph_alignment_node(pugi::xml_node paragraph_properties)
    -> pugi::xml_node {
    if (paragraph_properties == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_paragraph_spacing_node(pugi::xml_node paragraph_properties)
    -> pugi::xml_node {
    if (paragraph_properties == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_margins_node(pugi::xml_node properties, const char *container_name)
    -> pugi::xml_node {
...
auto ensure_table_style_borders_node(pugi::xml_node properties, const char *container_name)
    -> pugi::xml_node {
    if (properties == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_text_color_node(pugi::xml_node run_properties) -> pugi::xml_node {
    if (run_properties == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_bold_node(pugi::xml_node run_properties) -> pugi::xml_node {
    if (run_properties == pugi::xml_node{}) {
        return {};
    }
...
auto ensure_table_style_italic_node(pugi::xml_node run_properties) -> pugi::xml_node {
    if (run_properties == pugi::xml_node{}) {
        return {};
    }
    ...
    if (const auto bold = run_properties.child("w:b"); bold != pugi::xml_node{}) {
    ...
    if (const auto size = run_properties.child("w:sz"); size != pugi::xml_node{}) {
...
auto ensure_table_style_font_size_node(pugi::xml_node run_properties,
    ...
    if (const auto italic = run_properties.child("w:i"); italic != pugi::xml_node{}) {
...
auto apply_table_style_margin(pugi::xml_node margins, featherdoc::cell_margin_edge edge,
...
auto apply_table_style_margins(pugi::xml_node properties, const char *container_name,
                               const featherdoc::table_style_margins_definition &margins)
    -> bool {
    const auto margins_node = ensure_table_style_margins_node(properties, container_name);
    if (margins_node == pugi::xml_node{}) {
        return false;
    }

    return apply_table_style_margin(margins_node, featherdoc::cell_margin_edge::top,
                                    margins.top_twips) &&
           apply_table_style_margin(margins_node, featherdoc::cell_margin_edge::left,
                                    margins.left_twips) &&
           apply_table_style_margin(margins_node, featherdoc::cell_margin_edge::bottom,
                                    margins.bottom_twips) &&
           apply_table_style_margin(margins_node, featherdoc::cell_margin_edge::right,
                                    margins.right_twips);
}

auto apply_table_style_border(pugi::xml_node borders, featherdoc::table_border_edge edge,
                              const std::optional<featherdoc::border_definition> &value)
    -> bool {
    if (!value.has_value()) {
        return true;
    }
...
auto apply_table_style_borders(pugi::xml_node properties, const char *container_name,
                               const featherdoc::table_style_borders_definition &borders)
    -> bool {
    const auto borders_node = ensure_table_style_borders_node(properties, container_name);
    if (borders_node == pugi::xml_node{}) {
        return false;
    }

    return apply_table_style_border(borders_node, featherdoc::table_border_edge::top,
                                    borders.top) &&
           apply_table_style_border(borders_node, featherdoc::table_border_edge::left,
                                    borders.left) &&
           apply_table_style_border(borders_node, featherdoc::table_border_edge::bottom,
                                    borders.bottom) &&
           apply_table_style_border(borders_node, featherdoc::table_border_edge::right,
                                    borders.right) &&
...
auto apply_table_style_paragraph_spacing(
    ...
    const featherdoc::table_style_paragraph_spacing_definition &spacing) -> bool {
    const auto spacing_node = ensure_table_style_paragraph_spacing_node(paragraph_properties);
    ...
    if (spacing.line_rule.has_value()) {
        ensure_attribute_value(
            spacing_node, "w:lineRule",
            to_table_style_paragraph_line_spacing_rule_value(*spacing.line_rule));
    }

    return true;
}

auto apply_table_style_region(pugi::xml_node parent,
                              const featherdoc::table_style_region_definition &region,
                              bool whole_table) -> bool {
    if (region.fill_color.has_value()) {
        const auto cell_properties = ensure_table_style_cell_properties_node(parent);
    ...
    if (region.cell_margins.has_value()) {
        const auto properties = whole_table
                                    ? ensure_table_style_table_properties_node(parent)
    ...
    if (region.cell_vertical_alignment.has_value()) {
        ...
        ensure_attribute_value(
            vertical_alignment, "w:val",
            to_table_style_cell_vertical_alignment_value(*region.cell_vertical_alignment));
    }
    ...
    if (region.borders.has_value()) {
        const auto properties = whole_table
                                    ? ensure_table_style_table_properties_node(parent)
                                    : ensure_table_style_cell_properties_node(parent);
        if (!apply_table_style_borders(properties,
                                      whole_table ? "w:tblBorders" : "w:tcBorders",
                                      *region.borders)) {
            return false;
        }
    }
    ...
    if (region.cell_text_direction.has_value()) {
        const auto cell_properties = ensure_table_style_cell_properties_node(parent);
        const auto text_direction = ensure_table_style_text_direction_node(cell_properties);
        if (text_direction == pugi::xml_node{}) {
            return false;
        }
        ensure_attribute_value(
            text_direction, "w:val",
            to_table_style_cell_text_direction_value(*region.cell_text_direction));
    }

    if (region.paragraph_alignment.has_value()) {
        const auto paragraph_properties = ensure_table_style_paragraph_properties_node(parent);
        ...
        ensure_attribute_value(
            alignment, "w:val",
            to_table_style_paragraph_alignment_value(*region.paragraph_alignment));
    }
    ...
    if (region.text_color.has_value()) {
        const auto run_properties = ensure_table_style_run_properties_node(parent);
    ...
    if (region.font_size_points.has_value()) {
        const auto run_properties = ensure_table_style_run_properties_node(parent);
        const auto primary_size = ensure_table_style_font_size_node(run_properties, "w:sz");
        const auto complex_size = ensure_table_style_font_size_node(run_properties, "w:szCs");
    ...
    if (region.font_family.has_value() || region.east_asia_font_family.has_value()) {
        const auto run_properties = ensure_table_style_run_properties_node(parent);
        ...
        if (region.east_asia_font_family.has_value()) {
            ensure_attribute_value(run_fonts, "w:eastAsia", *region.east_asia_font_family);
        }
    }
...
auto apply_table_style_conditional_region(
    ...
    const std::optional<featherdoc::table_style_region_definition> &region) -> bool {
    if (!region.has_value()) {
        return true;
    }

    const auto conditional = ensure_table_style_conditional_node(style, type_name);
    return conditional != pugi::xml_node{} &&
           apply_table_style_region(conditional, *region, false);
}

auto apply_table_style_regions(pugi::xml_node style,
    ...
    return apply_table_style_conditional_region(style, "firstRow", definition.first_row) &&
           apply_table_style_conditional_region(style, "lastRow", definition.last_row) &&
           apply_table_style_conditional_region(style, "firstCol", definition.first_column) &&
           apply_table_style_conditional_region(style, "lastCol", definition.last_column) &&
           apply_table_style_conditional_region(style, "band1Horz", definition.banded_rows) &&
           apply_table_style_conditional_region(style, "band1Vert", definition.banded_columns) &&
           apply_table_style_conditional_region(style, "band2Horz",
                                                definition.second_banded_rows) &&
           apply_table_style_conditional_region(style, "band2Vert",
                                                definition.second_banded_columns);
}

auto validate_table_style_region(featherdoc::document_error_info &last_error_info,
                                 std::string_view region_name,
                                 const std::optional<featherdoc::table_style_region_definition>
                                     &region) -> bool {
    if (!region.has_value()) {
        return true;
    }
    ...
    if (region->font_size_points.has_value() && *region->font_size_points == 0U) {
        set_last_error(last_error_info, std::make_error_code(std::errc::invalid_argument),
                       "table style " + std::string{region_name} +
    ...
    if (region->font_size_points.has_value() &&
        *region->font_size_points > std::numeric_limits<std::uint32_t>::max() / 2U) {
        set_last_error(last_error_info, std::make_error_code(std::errc::invalid_argument),
                       "table style " + std::string{region_name} +
...
auto validate_table_style_regions(featherdoc::document_error_info &last_error_info,
    ...
    return validate_table_style_region(last_error_info, "whole_table",
           ...
           validate_table_style_region(last_error_info, "first_row", definition.first_row) &&
           validate_table_style_region(last_error_info, "last_row", definition.last_row) &&
...
auto read_table_style_margin(pugi::xml_node margins, featherdoc::cell_margin_edge edge)
    -> std::optional<std::uint32_t> {
    return parse_u32_attribute_value(
        margins.child(to_table_style_margin_name(edge)).attribute("w:w").value());
}

auto read_table_style_margins(pugi::xml_node properties, const char *container_name)
    ...
    summary.top_twips = read_table_style_margin(margins, featherdoc::cell_margin_edge::top);
    summary.left_twips = read_table_style_margin(margins, featherdoc::cell_margin_edge::left);
    summary.bottom_twips = read_table_style_margin(margins, featherdoc::cell_margin_edge::bottom);
    summary.right_twips = read_table_style_margin(margins, featherdoc::cell_margin_edge::right);
    return summary;
}

auto read_table_style_border(pugi::xml_node borders, featherdoc::table_border_edge edge)
    ...
    summary.size_eighth_points = parse_u32_attribute_value(border.attribute("w:sz").value());
    summary.color = read_non_empty_xml_attribute(border, "w:color");
    summary.space_points = parse_u32_attribute_value(border.attribute("w:space").value());
    return summary;
}

auto read_table_style_borders(pugi::xml_node properties, const char *container_name)
    ...
    summary.top = read_table_style_border(borders, featherdoc::table_border_edge::top);
    summary.left = read_table_style_border(borders, featherdoc::table_border_edge::left);
    summary.bottom = read_table_style_border(borders, featherdoc::table_border_edge::bottom);
    summary.right = read_table_style_border(borders, featherdoc::table_border_edge::right);
    summary.inside_horizontal =
        read_table_style_border(borders, featherdoc::table_border_edge::inside_horizontal);
    summary.inside_vertical =
        read_table_style_border(borders, featherdoc::table_border_edge::inside_vertical);
    return summary;
}
...
auto read_table_style_paragraph_spacing(pugi::xml_node paragraph_properties)
    ...
    summary.line_twips = parse_u32_attribute_value(spacing.attribute("w:line").value());
...
auto read_table_style_region(pugi::xml_node parent, bool whole_table)
    ...
    if (cell_properties != pugi::xml_node{}) {
        summary.fill_color =
            read_non_empty_xml_attribute(cell_properties.child("w:shd"), "w:fill");
        summary.cell_vertical_alignment =
            read_table_style_cell_vertical_alignment(cell_properties.child("w:vAlign"));
        summary.cell_text_direction =
            read_table_style_cell_text_direction(cell_properties.child("w:textDirection"));
    }

    const auto paragraph_properties = parent.child("w:pPr");
    if (paragraph_properties != pugi::xml_node{}) {
        summary.paragraph_alignment =
            read_table_style_paragraph_alignment(paragraph_properties.child("w:jc"));
    ...
    if (run_properties != pugi::xml_node{}) {
        summary.text_color =
            read_non_empty_xml_attribute(run_properties.child("w:color"), "w:val");
        summary.bold = read_on_off_value(run_properties.child("w:b"));
        summary.italic = read_on_off_value(run_properties.child("w:i"));
        if (const auto half_points =
                parse_u32_attribute_value(run_properties.child("w:sz").attribute("w:val").value())) {
            summary.font_size_points = *half_points / 2U;
        }
        summary.font_family = read_primary_font_family(run_properties);
        summary.east_asia_font_family = read_east_asia_font_family(run_properties);
    }

    const auto properties = whole_table ? parent.child("w:tblPr") : cell_properties;
    if (properties != pugi::xml_node{}) {
    ...
    if (!summary.fill_color.has_value() && !summary.text_color.has_value() &&
        ...
        !summary.font_size_points.has_value() && !summary.font_family.has_value() &&
...
auto find_table_style_conditional_node(pugi::xml_node style, std::string_view type_name)
    -> pugi::xml_node {
    for (auto conditional = style.child("w:tblStylePr"); conditional != pugi::xml_node{};
         conditional = conditional.next_sibling("w:tblStylePr")) {
        if (std::string_view{conditional.attribute("w:type").value()} == type_name) {
            return conditional;
        }
...
auto read_table_style_conditional_region(pugi::xml_node style, std::string_view type_name)
    -> std::optional<featherdoc::table_style_region_summary> {
    const auto conditional = find_table_style_conditional_node(style, type_name);
    if (conditional == pugi::xml_node{}) {
        return std::nullopt;
    }
...
auto table_style_paragraph_spacing_property_count(
    const featherdoc::table_style_paragraph_spacing_definition &spacing) -> std::size_t {
...
auto table_style_region_property_count(
    ...
    count += static_cast<std::size_t>(region.cell_vertical_alignment.has_value());
    ...
    if (region.paragraph_spacing.has_value()) {
        count += table_style_paragraph_spacing_property_count(*region.paragraph_spacing);
    }
    if (region.cell_margins.has_value()) {
...
Document::find_table_style_definition(std::string_view style_id) {
    if (!this->is_open()) {
        set_last_error(this->last_error_info, document_errc::document_not_open,
                       "call open() or create_empty() before reading table style definitions",
                       std::string{styles_xml_entry});
        return std::nullopt;
    }
    ...
    if (summary.style.kind != featherdoc::style_kind::table) {
        set_last_error(this->last_error_info,
                       std::make_error_code(std::errc::invalid_argument),
                       "style id '" + std::string{style_id} + "' is not a table style",
                       std::string{styles_xml_entry});
        return std::nullopt;
    }
    ...
    summary.first_column = read_table_style_conditional_region(style, "firstCol");
    summary.last_column = read_table_style_conditional_region(style, "lastCol");
    summary.banded_rows = read_table_style_conditional_region(style, "band1Horz");
    summary.banded_columns = read_table_style_conditional_region(style, "band1Vert");
    summary.second_banded_rows = read_table_style_conditional_region(style, "band2Horz");
...
table_style_region_audit_report Document::audit_table_style_regions(
    ...
    auto add_issue = [&](const style_summary &style, std::string region,
        ...
        issue.suggestion =
            "remove this empty table style region or add typed visual properties";
        report.issues.push_back(std::move(issue));
    };

    auto audit_region = [&](const style_summary &style, std::string_view region_name,
        ...
        const auto property_count =
            region.has_value() ? table_style_region_property_count(*region) : 0U;
    ...
    auto audit_style = [&](pugi::xml_node style) {
        ...
        auto audit_conditional = [&](std::string_view region_name,
            ...
            const auto conditional = find_table_style_conditional_node(style, xml_region);
...
table_style_inheritance_audit_report Document::audit_table_style_inheritance(
    ...
    if (!this->is_open()) {
        set_last_error(this->last_error_info, document_errc::document_not_open,
                       "call open() or create_empty() before auditing table style inheritance",
                       std::string{styles_xml_entry});
        return report;
    }
    ...
    auto add_issue = [&](const style_summary &style, std::string based_on_style_id,
    ...
    auto audit_style = [&](pugi::xml_node style) {
        ...
        while (current_style != pugi::xml_node{}) {
            ...
            if (!visited.insert(current_id).second) {
                ...
                add_issue(root_summary, current_id, "table", "inheritance_cycle",
                          chain,
                          "break the table style based_on cycle before resolving inheritance");
                return;
            }
            chain.push_back(current_id);
            ...
            if (parent_style == pugi::xml_node{}) {
                add_issue(root_summary, *current_summary.based_on, {},
            ...
            if (parent_summary.kind != style_kind::table) {
                add_issue(root_summary, parent_summary.style_id,
                          parent_summary.type_name, "based_on_not_table",
                          chain,
...
table_style_look_consistency_report Document::check_table_style_look_consistency() {
    ...
    auto add_issue = [&](std::size_t table_index, const std::string &style_id,
                         ...
                         std::string required_flag, std::optional<bool> actual_value,
                         std::string suggestion) {
    ...
    for (std::size_t table_index = 0U; table_handle.has_next();
        ...
        const auto style = find_style_node(styles_root, *style_id);
        if (style == pugi::xml_node{}) {
            add_issue(table_index, *style_id, "missing_style", {}, {}, std::nullopt,
        ...
        if (style_summary.kind != style_kind::table) {
            add_issue(table_index, *style_id, "style_not_table", {}, {}, std::nullopt,
        ...
        auto check_region = [&](std::string_view xml_region, std::string region_name,
                                std::string flag_name) {
            if (find_table_style_conditional_node(style, xml_region) == pugi::xml_node{}) {
                return;
            }
            ...
            const auto issue_type = actual_value.has_value() ? "style_look_disabled"
                                                             : "style_look_missing";
            add_issue(table_index, *style_id, issue_type, std::move(region_name),
                      std::move(flag_name), actual_value,
...
table_style_look_repair_report Document::repair_table_style_look_consistency() {
    ...
    auto required_flags_by_table = std::unordered_map<std::size_t,
...
table_style_quality_fix_plan Document::plan_table_style_quality_fixes() {
    ...
    for (const auto &issue : plan.audit.style_look.issues) {
        ...
        item.command = item.automatic ? "repair-table-style-look --plan-only" : "";
        item.suggestion = issue.suggestion;
        plan.items.push_back(std::move(item));
    }
