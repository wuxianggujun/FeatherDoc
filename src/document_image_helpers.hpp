...
inline constexpr auto document_xml_entry =
    std::string_view{"word/document.xml"};
inline constexpr auto document_relationships_xml_entry =
    std::string_view{"word/_rels/document.xml.rels"};
inline constexpr auto content_types_xml_entry =
    std::string_view{"[Content_Types].xml"};
inline constexpr auto office_document_relationships_namespace_uri =
    std::string_view{
        "http://schemas.openxmlformats.org/officeDocument/2006/relationships"};
inline constexpr auto image_relationship_type =
...
inline constexpr auto drawingml_main_namespace_uri =
    std::string_view{"http://schemas.openxmlformats.org/drawingml/2006/main"};
...
[[nodiscard]] auto relationships_document_allows_mutation(
...
auto set_last_error(featherdoc::document_error_info &error_info,
    ...
    -> std::error_code;
[[nodiscard]] auto
make_part_relationship_target(std::string_view source_entry_name,
...
[[nodiscard]] auto image_extension_from_entry_name(std::string_view entry_name)
    -> std::string;
[[nodiscard]] auto normalize_image_extension(std::string_view extension)
    -> std::string;
[[nodiscard]] auto image_extensions_equivalent(std::string_view left,
                                               std::string_view right) -> bool;
[[nodiscard]] auto read_zip_entry_binary(zip_t *archive,
...
[[nodiscard]] auto
find_image_relationship_node(pugi::xml_node relationships_root,
...
[[nodiscard]] auto
to_xml_reference(featherdoc::floating_image_horizontal_reference reference)
    -> std::string_view;
[[nodiscard]] auto
to_xml_reference(featherdoc::floating_image_vertical_reference reference)
    -> std::string_view;
void append_wrap_mode_node(pugi::xml_node drawing_container,
                           featherdoc::floating_image_wrap_mode wrap_mode);
[[nodiscard]] auto
is_valid_floating_crop(const featherdoc::floating_image_crop &crop) -> bool;
