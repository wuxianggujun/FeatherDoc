...
using detail::commit_staged_cell_properties;
using detail::commit_staged_table_child;
using detail::commit_staged_table_layout;
using detail::current_table_column_count;
using detail::current_table_row_column_count;
...
using detail::max_table_grid_columns;
...
using detail::replace_table_cell_texts;
using detail::rollback_inserted_table_cells;
using detail::rollback_staged_cell_properties;
using detail::rollback_staged_table_child;
using detail::rollback_staged_table_layout;
using detail::stage_cell_properties;
using detail::stage_cleared_fixed_layout_cell_widths_covering_column;
using detail::stage_fixed_layout_cell_widths;
using detail::stage_table_child;
using detail::stage_table_layout;
using detail::staged_cell_properties;
using detail::staged_table_child;
using detail::staged_table_layout;
...
using detail::tracked_cell_body_replacement;
