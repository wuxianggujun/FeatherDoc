...
using featherdoc_cli::inspect_default_run_properties_options;
using featherdoc_cli::inspect_style_run_properties_options;
using featherdoc_cli::inspect_paragraph_style_properties_options;
...
using featherdoc_cli::set_default_run_properties_options;
using featherdoc_cli::clear_default_run_properties_options;
using featherdoc_cli::set_paragraph_style_properties_options;
using featherdoc_cli::clear_paragraph_style_properties_options;
using featherdoc_cli::materialize_style_run_properties_options;
using featherdoc_cli::rebase_style_based_on_options;
using featherdoc_cli::set_style_run_properties_options;
using featherdoc_cli::clear_style_run_properties_options;
...
using featherdoc_cli::parse_inspect_default_run_properties_options;
using featherdoc_cli::parse_inspect_style_run_properties_options;
using featherdoc_cli::parse_inspect_paragraph_style_properties_options;
...
using featherdoc_cli::parse_set_default_run_properties_options;
using featherdoc_cli::parse_clear_default_run_properties_options;
using featherdoc_cli::parse_set_paragraph_style_properties_options;
using featherdoc_cli::parse_clear_paragraph_style_properties_options;
using featherdoc_cli::parse_materialize_style_run_properties_options;
using featherdoc_cli::parse_rebase_style_based_on_options;
using featherdoc_cli::parse_set_style_run_properties_options;
using featherdoc_cli::parse_clear_style_run_properties_options;
...
int featherdoc_cli_main(int argc, char **argv) {
    ...
    if (command == "rebase-character-style-based-on") {
        ...
        std::string error_message;
        if (!parse_rebase_style_based_on_options(arguments, 4U, options, error_message)) {
            print_parse_error(command, error_message, json_output);
            return 2;
        }
        ...
        if (!doc.rebase_character_style_based_on(style_id, based_on)) {
            report_document_error(command, "mutate", doc.last_error(),
                                  options.json_output);
            return 1;
        }
