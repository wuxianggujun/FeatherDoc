...
void print_usage(std::ostream &stream) {
    stream
        ...
        << "  featherdoc_cli append-total-pages-field <input.docx>"
           ...
           " [--kind default|first|even] [--dirty] [--locked]"
           " [--output <path>] [--json]\n"
        << "  featherdoc_cli append-table-of-contents-field <input.docx>"
           " --part body|header|footer|section-header|section-footer"
           " [--index <part-index>] [--section <section-index>]"
           " [--kind default|first|even]"
           " [--min-outline-level <1-9>] [--max-outline-level <1-9>]"
           " [--no-hyperlinks] [--show-page-numbers-in-web-layout]"
           " [--no-outline-levels] [--result-text <text>]"
           " [--dirty] [--locked] [--output <path>] [--json]\n"
        << "  featherdoc_cli append-field <input.docx> <instruction>"
           " --part body|header|footer|section-header|section-footer"
           " [--index <part-index>] [--section <section-index>]"
           " [--kind default|first|even] [--result-text <text>]"
           " [--dirty] [--locked] [--output <path>] [--json]\n"
        << "  featherdoc_cli append-reference-field <input.docx>"
           " <bookmark-name> --part body|header|footer|section-header|section-footer"
           " [--index <part-index>] [--section <section-index>]"
           " [--kind default|first|even] [--result-text <text>]"
           " [--no-hyperlink] [--dirty] [--locked]"
        ...
        << "  featherdoc_cli append-hyperlink-field <input.docx>"
           ...
           " [--no-preserve-formatting] [--output <path>] [--json]\n"
        << "  featherdoc_cli append-sequence-field <input.docx>"
           " <identifier> --part body|header|footer|section-header|section-footer"
           " [--index <part-index>] [--section <section-index>]"
           " [--kind default|first|even] [--result-text <text>]"
           " [--number-format <format>] [--restart <n>]"
        ...
        << "  featherdoc_cli append-complex-field <input.docx>"
           ...
           " [--kind default|first|even] [--result-text <text>]"
           " [--dirty] [--locked] [--output <path>] [--json]\n"
        << "  featherdoc_cli replace-field <input.docx> <field-index>"
           " <instruction> --part body|header|footer|section-header|section-footer"
           " [--index <part-index>] [--section <section-index>]"
           " [--kind default|first|even] [--result-text <text>]"
           " [--output <path>] [--json]\n"
