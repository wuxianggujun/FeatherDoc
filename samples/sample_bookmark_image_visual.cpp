...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:body>
    <w:p>
      <w:r>
        <w:t>Bookmark image visual regression baseline.</w:t>
      </w:r>
    </w:p>
    <w:p>
      <w:r>
        <w:t>The placeholder paragraph below should become a visible inline image between the before and after lines.</w:t>
      </w:r>
    </w:p>
    ...
    <w:p>
      <w:r>
        <w:t>This retained paragraph should remain below the inserted image so the rendered layout stays easy to compare.</w:t>
      </w:r>
    </w:p>
    <w:sectPr>
...
int main(int argc, char **argv) {
    const fs::path output_path =
        argc > 1 ? fs::path(argv[1])
                 : fs::current_path() / "bookmark_image_visual_baseline.docx";
