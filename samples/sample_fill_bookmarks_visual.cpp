...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:body>
    <w:p>
      <w:r>
        <w:t>Fill bookmarks visual regression baseline.</w:t>
      </w:r>
    </w:p>
    <w:p>
      <w:r>
        <w:t>The body bookmark placeholders below should be replaced in place while the labels and overall paragraph order remain stable.</w:t>
      </w:r>
    </w:p>
    <w:p>
      <w:r><w:t>Customer: </w:t></w:r>
      <w:bookmarkStart w:id="0" w:name="customer_name"/>
    ...
    <w:p>
      <w:r><w:t>Account manager: </w:t></w:r>
      <w:bookmarkStart w:id="2" w:name="account_manager"/>
      <w:r><w:t>old manager</w:t></w:r>
      <w:bookmarkEnd w:id="2"/>
    </w:p>
    <w:p>
      <w:r><w:t>Project summary: </w:t></w:r>
      <w:bookmarkStart w:id="3" w:name="project_summary"/>
      <w:r><w:t>old summary</w:t></w:r>
      <w:bookmarkEnd w:id="3"/>
    </w:p>
    <w:p>
      <w:r>
        <w:t>Review note: This retained line should remain below the filled summary so the rendered order is easy to compare.</w:t>
      </w:r>
    </w:p>
    <w:sectPr>
...
int main(int argc, char **argv) {
    const fs::path output_path =
        argc > 1 ? fs::path(argv[1])
                 : fs::current_path() / "fill_bookmarks_visual_baseline.docx";
