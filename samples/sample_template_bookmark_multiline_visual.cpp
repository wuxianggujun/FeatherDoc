...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"
  ...
  <w:body>
    <w:p>
      <w:r>
        <w:t>Template bookmark multiline visual regression baseline.</w:t>
      </w:r>
    </w:p>
    <w:p>
      <w:r>
        <w:t>The retained header and footer lines must remain unchanged. Each target bookmark should render as two visible lines after mutation.</w:t>
      </w:r>
    </w:p>
    <w:p>
      <w:r>
        <w:t>Body bookmark target:</w:t>
      </w:r>
    </w:p>
    <w:p>
    ...
    <w:p>
      <w:r>
        <w:t>This retained body paragraph should stay visually separate from the mutated body bookmark above.</w:t>
      </w:r>
    </w:p>
    <w:p>
      <w:r>
        <w:t>The page intentionally stays short so the header, body, and footer evidence are all visible in the same screenshot.</w:t>
      </w:r>
    </w:p>
    <w:sectPr>
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:p>
    <w:bookmarkStart w:id="2" w:name="footer_note"/>
    <w:r><w:t>Footer placeholder</w:t></w:r>
...
int main(int argc, char **argv) {
    const fs::path output_path =
        argc > 1 ? fs::path(argv[1])
                 : fs::current_path() /
                       "template_bookmark_multiline_visual_baseline.docx";
