...
后续 PDF CJK、治理与视觉推进记录已拆分到以下存档，主文件保留当前主线判断、验证入口和早期复核结论：

* ``document_api_mainline_status_zh_pdf_cjk_archive.rst``
* ``document_api_mainline_status_zh_governance_visual_archive.rst``
